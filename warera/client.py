...
class WareraClient:
    ...
    def batch(self, max_batch_size: int | None = None, concurrency: int | None = None) -> BatchSession:
        """
        ...
        return BatchSession(
            ...
            max_batch_size=min(max_batch_size, MAX_BATCH_SIZE) if max_batch_size else self._max_batch_size,
