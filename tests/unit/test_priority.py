...
async def test_priority_queueing() -> None:
    ...
    f_normal1 = asyncio.create_task(session.get("proc.normal1", {}, priority=RequestPriority.NORMAL))
    f_normal2 = asyncio.create_task(session.get("proc.normal2", {}, priority=RequestPriority.NORMAL))
